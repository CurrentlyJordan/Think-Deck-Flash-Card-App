...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, Serializable {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Decks) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_holder, new ListOfDecksFragment()).commit();
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_holder, new NewDeckFragment()).commit();
